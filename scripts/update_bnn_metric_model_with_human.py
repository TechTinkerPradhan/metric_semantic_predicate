...
from metric_semantic_predicate.models.bnn_metric_model import train_bnn_model_metric, bnn_predict_metric, BayesianNN_metric
...
def main():
    ...
    svi, net = train_bnn_model_metric(X_h_train_t, Y_h_train_t,
                                      input_dim=input_dim,
